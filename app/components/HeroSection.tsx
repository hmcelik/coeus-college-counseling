...
const HeroSection: React.FC = () => {
  return (
    <div className="bg-blue-500 text-white h-[100vh] md:h-[100vh] flex flex-col-reverse md:flex-row items-center pt-32 md:pt-16 px-6 md:px-20 pb-10 relative overflow-hidden">
